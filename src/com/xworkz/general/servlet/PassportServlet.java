...
import com.xworkz.general.service.PassportServiceImplement;
...
public class PassportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws ServletException, IOException {
        ...
        PassportService passportService=new PassportServiceImplement();
        String result=passportService.validateAndSave(passportDTO);
